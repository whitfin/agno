"""
👩‍💻 Running Agent generated code in Daytona
...
DAYTONA_API_KEY = getenv("DAYTONA_API_KEY")
DAYTONA_API_URL = getenv("DAYTONA_API_URL")
...
def run_code_in_daytona(code: str) -> None:
    ...
    if response.exit_code != 0:
        ...
        print("--------------------------------")
        print("👩‍💻 Daytona code execution result:")
        print("--------------------------------")
