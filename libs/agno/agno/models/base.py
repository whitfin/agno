...
class Model(ABC):
        ...
        while True:
            ...
            if has_tool_calls:
                ...
                for function_call_response in self.run_function_calls(
                    ...
                    if (
                        function_call_response.event in [ModelResponseEvent.tool_call_completed.value, ModelResponseEvent.tool_call_confirmation_required.value]
                        ...
                        if function_call_response.content:
                            model_response.content += function_call_response.result  # type: ignore
    ...
    def get_function_call_to_run_from_tool_execution(self, tool_execution: ToolExecution) -> FunctionCall:
    ...
    def _handle_agent_exception(self, a_exc: AgentRunException, additional_messages: Optional[List[Message]] = None) -> None:
    ...
    def run_function_call(self, function_call: FunctionCall, function_call_results: List[Message], additional_messages: Optional[List[Message]] = None) -> Iterator[ModelResponse]:
        # Start function call
            ...
            # TODO: If tool call contains media, yield media
            ...
            function_call_result = self._create_function_call_result(
                function_call, function_call_success, function_call_output, function_call_timer
            )
            yield ModelResponse(
    ...
    def run_function_calls(
        ...
        for fc in function_calls:
            ...
            yield from self.run_function_call(fc, function_call_results, additional_messages)
    ...
    async def _arun_function_call(
        ...
        function_call_timer = Timer()
        function_call_timer.start()
        success: Union[bool, AgentRunException] = False  # type: ignore
        try:
            if (
