...
editor.print_response("Write an article about latest developments in AI.", stream_intermediate_steps=True)
# asyncio.run(editor.aprint_response(
#     "Write an article about latest developments in AI.", stream_intermediate_steps=True,))
