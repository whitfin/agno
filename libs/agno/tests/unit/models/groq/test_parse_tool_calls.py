...
class MockToolCall:
    """Mock object to simulate ChoiceDeltaToolCall structure for Groq"""
...
class TestGroqParseToolCalls:
    """Test suite for Groq parse_tool_calls method to ensure our concatenation fix works correctly"""
    ...
    def test_parse_single_complete_tool_call(self):
        ...
        result = Groq.parse_tool_calls(tool_calls_data)
