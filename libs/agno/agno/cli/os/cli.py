...
This is the entrypoint for the `ag os` application.
"""
...
os_cli = typer.Typer(
    name="os",
    short_help="Manage your Agent OS",
    help="""\b
Use `ag os [COMMAND]` to create, setup, start or stop your Agent OS.
...
@os_cli.command(short_help="Initialize an Agent OS in the current directory.")
def init(
