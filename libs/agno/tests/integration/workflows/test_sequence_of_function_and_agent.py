...
def test_basic_sequence(workflow_db):
...
def test_function_and_agent_sequence(workflow_db, test_agent):
...
def test_function_and_team_sequence(workflow_db, test_team):
...
def test_function_streaming_sequence(workflow_db):
...
@pytest.mark.asyncio
async def test_async_function_streaming(workflow_db):
...
def test_mixed_sequence(workflow_db, test_agent, test_team):
