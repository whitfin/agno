"""
This example demonstrates how to use shared state between team members.

The team maintains a shared shopping list that can be modified by different agents
while preserving state across interactions.
"""
...
# Create shopping list management agent
shopping_list_agent = Agent(
    ...
    instructions=[
        "You are responsible for managing the shopping list",
        "Use the provided tools to add, remove, or clear items",
    ],
)
...
# Example usage demonstrating shared state
