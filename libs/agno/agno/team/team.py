...
class Team:
            ...
            try:
                ...
                if stream:
                    return generator_wrapper(  # type: ignore
                        create_team_run_cancelled_event(run_response, "Operation cancelled by user")
                    )
                else:
                    return run_response
    ...
    def _print_response_stream(
        ...
        **kwargs: Any,
        ...
        with Live(console=console) as live_console:
            ...
            response_timer.stop()
            run_response = self.get_run_response(run_id=run_id)  # type: ignore
    ...
    def get_run_response(self, run_id: str, session_id: Optional[str] = None) -> Optional[TeamRunOutput]:
        """
    ...
    def _log_team_run(self, session_id: str, user_id: Optional[str] = None) -> None:
        ...
        #
        # try:
        #     team_session: TeamSession = self.team_session or self._read_or_create_session(
